...
// See: https://github.com/dep2p/multiformats/multistream/issues/20
...
func (l *lazyClientConn[T]) Close() error {
	...
	// drop the stream.
	//
	// Note: We currently handle this case in Go(https://github.com/dep2p/multiformats/multistream/pull/87), but rust-dep2p does not.
